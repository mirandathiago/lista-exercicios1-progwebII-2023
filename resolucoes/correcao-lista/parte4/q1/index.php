...
<body>
	<header>
		<h1>Questão 1 - Parte 4</h1>
	</header>
	<div class="container">
		<div class="box formulario">
			<h2>Escreva um formulário que tenha um campo do tipo checkbox que permita que sejam marcadas as frutas favoritas de um usuário. (Devem existir ao menos 5 frutas para serem escolhidas). Em seguida processe a informação deste formulário utilizando o comando For Each para apresentar as frutas que foram escolhidas. 
</h2>
