...
de sua residência. Para ajudá-lo crie um formulário que receba o consumo de energia elétrica em kWh (quilowatts-hora). 
	...
	<div class="container">
		<div class="box formulario">
			...
			<form action="receber1.php" method="get">
				...
				<label> Consumo
					<input type="number" name="consumo" required step = "1" value = "100">
				</label>
