...
<?php
  ...
  $imc = $peso / ($altura * $altura); //Declarei a variável imc, e o calculo que ela realiza

//Criei um if e else, para mostrar a classificação do imc da pessoa 
    if($imc < 18.5){
...
<body>
    ...
    <h2>Seu IMC é: <?=$imc number_format(2)?> , você está <?=$mensagem?></h2>
