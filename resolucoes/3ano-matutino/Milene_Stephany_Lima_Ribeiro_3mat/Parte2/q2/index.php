...
<body>
    <header>
        <h1>Valor da conta de Energia:</h1>
    </header>
    <div class="container">
        <div class="box Lista">
            <form action="index.php" method="get">
                <label>Consumo de Energia:
                    <input type="number" id="number" name="consumo"
step="0.01" required value="<?$consumo?>">
                </label>
                <button name="enviar"> Enviar</button>     
               </div>
    </div>
    <div class="box respostas"></div>
    <h2> Conta de energia </h2>
    <?php
    $metodo = $_SERVER ["REQUEST_METHOD"];
    if($metodo = "GET"){
        echo "<h3> Valor da Conta de Energia: </h3>";
