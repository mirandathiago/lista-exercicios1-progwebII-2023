...
Crie um formulário em HTML que permita ao usuário inserir as seguintes informações: idade (em anos), peso (em kg), 
altura (em cm) e gênero (masculino ou feminino). Em seguida, crie um script em PHP que calcule a 
taxa de metabolismo basal (TMB) do usuário, utilizando a seguinte fórmula:
    ...
    <div class="box Lista">
        ...
        <form action="index.php" method="POST">
           ...
           <fieldset>
            <p>Gênero:</p>
            <div>
              <input type="checkbox" id="masculino" name="genero" value="M">
              <label for="masculino">Masculino</label>
            </div>
            <div>
              <input type="checkbox" id="feminino" name="genero" value="F">
        ...
        if($metodo == "POST"){
            switch($genero){
                case "M":
                    ...
                    echo "$nome, você gasta $taxa calorias por dia. <br>";
                    break;
